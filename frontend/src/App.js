...
// the constructor() does the initialzation job
// handleChange() is triggered when the input changes
// handleClick() is triggered when clicking any of the buttons
// render() inludes the page desgin
// you may want to start with reading render() first
